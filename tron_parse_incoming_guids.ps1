...
param (
    # Path to master file
    [string] $byGUIDListFile = ".\resources\stage_2_de-bloat\oem\programs_to_target_by_GUID.txt",

    # Path to toolbar/BHO file
    [string] $toolbarBHOListFile = ".\resources\stage_2_de-bloat\oem\toolbars_BHOs_to_target_by_GUID.txt",

    # Path to GUID whitelist file
    [string] $whitelistGUIDPath = ".\tron_guid_whitelist.txt",
    ...
    [string] $incomingGUIDDirectory = ".\unsorted",

    # Path to output directory
    [string] $outputFile = ".\unsorted\guid_parsed_dump.txt"
