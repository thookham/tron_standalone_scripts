...
- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2025-11-27**: Audit fixes: Remove hardcoded creds, modernize scripts, update README (4117e9a) - **2017-02-09**: v1.5.3 (5830c87) - **2016-10-29**: v1.5.3 (552ab02)

### microsoft_offline_update_launcher.bat

- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2017-05-06**: Create microsoft_offline_update_launcher.bat (4a7bb23)

### convert_archives_to_7z.bat

- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2022-12-18**: add conversion verification and log dir check (46767ad) - **2022-12-17**: remove debug pause command (4d95b04) - **2022-12-17**: Add multithreading and compression level 9 (highest) (da0bcde) - **2022-12-16**: Rename Convert RAR and ZIP to 7z.bat to convert_archives_to_7z.bat (3990d13)
...
- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2024-05-12**: Create clean_MKV_data.bat (6c71f51)
...
- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2025-11-27**: Audit fixes: Remove hardcoded creds, modernize scripts, update README (4117e9a) - **2020-12-04**: Add files via upload (67ade82) - **2015-08-28**: v1.0.0 (86890f0)

### remove_libraries_icon_from_desktop.bat
...
### dhcp_server_watchdog.bat

- **2015-03-11**: v1.3.1 (c3a467b) - **2014-09-08**: Create dhcp_server_watchdog.bat (d20917b)

### launch_vmware_workstation.bat

- **2019-12-19**: Create launch_vmware_workstation.bat (4815678)

### map_printers.bat

- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2019-11-14**: Update map_printers.bat (1b25156) - **2019-11-14**: Add files via upload (ef32868)
...
- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2025-11-27**: Audit fixes: Remove hardcoded creds, modernize scripts, update README (4117e9a) - **2020-07-22**: Enables remote desktop on a REMOTE machine (3a6b0c5)

### disable_shortcut_to_text.reg

- **2022-10-12**: Add files via upload (2908964)

### disable_win_s_hotkey.bat

- **2020-04-30**: Add files via upload (8c7e772)

### enable_Powershell_scripts_run_by_double-clicking.reg

- **2022-10-12**: Add files via upload (4f0cc4c)

### show_windows_version_on_desktop.reg
...
### Linux one-liners (bash).sh

- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2024-11-12**: Update Linux one-liners (bash).sh (bec9b41) - **2024-07-03**: Update Linux one-liners (bash).sh (bca8094) - **2023-04-19**: Update Linux one-liners (bash).sh (57ee4da) - **2020-12-04**: Add files via upload (438d8d3)
...
### aexp_nsm_task_tagger.ps1

- **2025-11-28**: Audit fixes: Parameterize scripts, remove hardcoded credentials, update docs (96e6e40) - **2017-06-16**: Update aexp_nsm_task_tagger.ps1 (4899e0f) - **2017-03-24**: v1.0.1 (3a25192) - **2017-03-24**: v1.0.1 (2462c2f) - **2017-03-23**: v1.0.0 (05b5026)

### ahk_v2_rapid_mouse_click_capslock_toggle.ahk
