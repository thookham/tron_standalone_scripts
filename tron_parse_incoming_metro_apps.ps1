...
param (
    ...
    [string] $metro3rdPartyListFile = ".\resources\stage_2_de-bloat\metro\metro_3rd_party_modern_apps_to_target_by_name.ps1",

    # Path to master Microsoft list
    [string] $metroMicrosoftListFile = ".\resources\stage_2_de-bloat\metro\metro_Microsoft_modern_apps_to_target_by_name.ps1",

    # Path to Metro app whitelist file
    [string] $metroWhitelistFile = ".\tron_metro_whitelist.txt",
    ...
    [string] $incomingMetroDirectory = ".\unsorted",

    # Path to output directory
    [string] $outputFile = ".\unsorted\metro_parsed_dump.txt"
